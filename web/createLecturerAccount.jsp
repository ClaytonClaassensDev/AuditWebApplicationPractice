...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="createLecturerAccount.css">
    ...
    <div class="form">
        <form name="createStudentAccountForm"  method="post" action="<%= request.getContextPath()%>/createStudentAccount"  >
            ...
            <ul class="list">
                ...
                <li>Student Number <input type = "student_id" student_id = "student_id" class = "sign-up-form" placeholder="student number_required">
                ...
                <li>Repeat Password: <input type="password" name="password" class="sign-up-form" placeholder="repeat password"></li>
                <li>
